...
<head>
  ...
  <title>Mon blog de dev, basé sur bootstrap</title>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Dev Blog</h1>
            <span class="subheading">Anthony Fachaux</span>
            <span class="subheading">Mon blog de dev, basé sur bootstrap</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
          <ul class="list-inline text-center">
            <li class="list-inline-item">
              <a href="https://twitter.com/anthonyfachaux">
            ...
            <li class="list-inline-item">
              <a href="https://www.linkedin.com/in/anthony-fachaux-61838616b/">
                <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x"></i>
            ...
            <li class="list-inline-item">
              <a href="https://github.com/nayodahl/OCProject5">
                <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x"></i>
